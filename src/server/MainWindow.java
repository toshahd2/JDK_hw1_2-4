...
public class MainWindow extends JFrame {
    ...
    private JLabel label = new JLabel("Введите сообщение: ");
    private JTextField textInput = new JTextField();
    private JButton buttonConnect = new JButton("Отправить");
    private JPanel grid = new JPanel(new GridLayout(3, 1));
    private JPanel message = new JPanel(new GridLayout(1, 2));
